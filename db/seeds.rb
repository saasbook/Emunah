...
User.create(email: 'damon@gmail.com', password: 'abcdef', full_name: 'Damon Li', is_admin: 'No')
User.create(email: 'bob@gmail.com', password: 'abcdef', full_name: 'Bob Law', is_admin: 'No')
User.create(email: 'jan@gmail.com', password: 'abcdef', full_name: 'Jan Mark', is_admin: 'No')
